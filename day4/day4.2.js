...
const isOverlapping = (arr1, arr2) => {
  ...
  const contained1 = arr1[0] >= arr2[0] && arr1[0] <= arr2[1]
  const contained2 = arr2[0] >= arr1[0] && arr2[0] <= arr1[1]
...
const day4 = (input) => {
  ...
  assignmentPairs.forEach(pair => {
    ...
    if(isOverlapping(assignment1, assignment2)) score++
  })
  return score;
};

module.exports = { day4, isOverlapping };
